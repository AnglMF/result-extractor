...
class RankingTest(unittest.TestCase):
    ...
    mock_competitor1.register_placing('t1', 1)
    mock_competitor1.register_placing('t2', 1)
    mock_competitor1.register_placing('t3', 3)
    mock_competitor1.register_placing('t4', 1)
    mock_competitor1.register_placing('t5', 1)
    mock_competitor2.register_placing('t1', 2)
    mock_competitor2.register_placing('t2', 7)
    mock_competitor2.register_placing('t3', 5)
    mock_competitor2.register_placing('t4', 7)
    mock_competitor2.register_placing('t5', 3)
    mock_competitor3.register_placing('t1', 3)
    mock_competitor3.register_placing('t4', 2)
    mock_competitor3.register_placing('t5', 2)
    mock_competitor4.register_placing('t1', 5)
    mock_competitor4.register_placing('t3', 1)
    mock_competitor4.register_placing('t4', 7)
    mock_competitor4.register_placing('t5', 9)
    mock_competitor5.register_placing('t5', 2)
